...
% Load Vocabulary
vocabList = getVocabList(); %获得总的单词列表 
% Init return value
word_indices = [];
% ========================== Preprocess Email ===========================
% Find the Headers ( \n\n and remove )
...
% Strip all HTML 替换html
% Looks for any expression that starts with < and ends with > and replace
% and does not have any < or > in the tag it with a space
email_contents = regexprep(email_contents, '<[^<>]+>', ' ');

% Handle Numbers  0-9用number替换
...
% Handle Email Addresses  处理电子邮件地址  找@
...
while ~isempty(email_contents)
    % Tokenize and also get rid of any punctuation  令牌化，并摆脱任何标点符号
    ...
    % Look up the word in the dictionary and add to word_indices 查找字典中的单词，并添加到word_indices中
    % ====================== YOUR CODE HERE ======================
